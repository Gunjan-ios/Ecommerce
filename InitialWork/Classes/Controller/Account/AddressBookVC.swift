...
class AddressBookVC: ParentViewController,UITableViewDelegate,UITableViewDataSource {
 @IBOutlet weak var  AddressList: UITableView!
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return EditAddressCell.ALLAddress.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let order = EditAddressCell.ALLAddress[indexPath.row]
