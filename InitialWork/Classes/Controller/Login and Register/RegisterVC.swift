...
class RegisterVC: ParentViewController,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var btn_privacy: RegularFontButton!
    @IBOutlet weak var blurview: UIView!
    @IBOutlet weak var blur: UIVisualEffectView!
    @IBOutlet weak var BtnLogin: RegularFontButton!
...
//        self.registerNotifications()
    ...
    @IBAction func OnSubmitPressed(_ sender: Any)
    {
        ...
        let otpview = self.storyboard?.instantiateViewController(withIdentifier: Strings.Identifiers.OTPvc) as! OTPvc
